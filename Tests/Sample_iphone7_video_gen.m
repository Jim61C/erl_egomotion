...
v = VideoWriter('Data/Video/iphone7.avi');
v.FrameRate = 2;
open(v);
standard_size = nan;
...
for i = 41: 10:419
    ...
    im1 = imread(sprintf('Data/Sample/Output/iphone7_flow/%04d.png', i));
    im2 = imread(sprintf('Data/Sample/Output/iphone7_residual/%04d.png', i));
    im3 = imread(sprintf('Data/Sample/Output/iphone7_trajectory/%04d.png', i));
    figure(f),
    subplot(2,2, [1 2]);
    image(im1);
    axis off
