...
test_name = 'rgbd_desk2_secret';
frame_info = importdata('Data/Sample/Intrinsics/rgbd_dataset_freiburg1_desk2_secret.txt', ' ');
input_path = 'Data/Sample/Input/rgbd_dataset_freiburg1_desk2_secret';
load('Data/Sample/Intrinsics/TUM1.mat');

header_len = 3;
frame_id_to_img_file = Sample_TestDriver(test_name, input_path,frame_info, ...
    K, 1, length(frame_info) - header_len, 1);
